  ...
  return (
    <AppProvider>
      <Routes>
        ...
        <Route path="/atividadeDoAluno/:idAtividade" element={<AdicionarTrabalhoDoTcc />} />{/** MUDEI aqui */}
        ...
        <Route path="/atividadeOrientador/:idAtividade" element={<AtividadeOrientador />} />{/**MUDEI aqui */}
